...
_**DATABASE BACKUP**_
Backup your database with the following instruction
```shell
docker exec lamp-database mysqldump -u root --password=tiago tiago > backup.sql
```

Restore your database backup
```shell
cat backup.sql | docker exec -i lamp-database mysql -u root --password=tiago tiago
```
